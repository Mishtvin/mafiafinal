...
export default function VideoConference() {
  ...
  const roomOptions: RoomOptions = {
    ...
    // Дополнительные параметры только для видео
    // WebRTC-специфичные настройки
    rtcConfig: {
      // Устанавливаем более агрессивные таймауты для ICE подключения
      iceTransportPolicy: 'all', // Используем все доступные транспорты
      // Включаем дополнительные ICE сервера для улучшения связи
      iceServers: [
        { urls: 'stun:stun.l.google.com:19302' },
        { urls: 'stun:stun1.l.google.com:19302' },
      ],
      // Более агрессивные настройки подключения
